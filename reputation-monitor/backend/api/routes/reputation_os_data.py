...
def get_narrative_texts(tenant_id: str) -> list[str]:
    ...
    extras = {
        ...
        "prabhasx": [
            "Prabhas's latest release was a huge letdown at the box office",
            "The storyline was weak — not what we expected after Baahubali",
            "Terrible VFX for the budget — Prabhas deserved better direction",
            "The Hindi dubbing completely ruined the dialogues for Prabhas",
            "This film had so much potential but the execution was poor",
            "The fan wars in the comments are getting out of control",
            "Who greenlit this script for a star like Prabhas?",
            "Another disappointing big-budget film — the magic is fading",
            "The item song felt forced and hurt the film's narrative",
            "Prabhas needs to choose better directors for his next project",
        ],
        "default": [
...
def get_influencer_users(tenant_id: str) -> list[dict]:
    profiles = {
        ...
        "prabhasx": [
            {"username": "box_office_watchdog", "posts": 35, "sentiment_avg": -0.78, "reach": 280000, "engagement": 11.0},
            {"username": "film_flop_tracker", "posts": 28, "sentiment_avg": -0.85, "reach": 150000, "engagement": 9.0},
            {"username": "tollywood_gossip_king", "posts": 45, "sentiment_avg": -0.70, "reach": 95000, "engagement": 14.0},
            {"username": "prabhas_fan_forever", "posts": 60, "sentiment_avg": 0.80, "reach": 8000, "engagement": 16.0},
            {"username": "cinema_analyst_india", "posts": 15, "sentiment_avg": 0.05, "reach": 200000, "engagement": 4.5},
            {"username": "south_media_outlet", "posts": 10, "sentiment_avg": -0.15, "reach": 500000, "engagement": 3.0},
            {"username": "silent_prabhas_fan", "posts": 5, "sentiment_avg": 0.10, "reach": 1200, "engagement": 0.8},
            {"username": "former_baahubali_fan", "posts": 22, "sentiment_avg": -0.55, "reach": 65000, "engagement": 7.5},
        ],
        "default": [
