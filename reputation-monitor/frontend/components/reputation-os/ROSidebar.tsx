...
export default function ROSidebar({
  ...
  return (
    ...
    >
      ...
      {/* Tenant Indicator (read-only — tenant is derived from subdomain) */}
      {!collapsed && tenantName && (
        <div className="border-b border-slate-800/60 px-3 py-3">
          <div className="flex w-full items-center gap-2 rounded-lg bg-slate-800/40 px-3 py-2 text-sm text-slate-300">
