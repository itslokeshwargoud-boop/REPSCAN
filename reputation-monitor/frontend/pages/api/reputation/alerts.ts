 ...
 *
 * Returns alerts derived from real Talk + Feed data via the Processing Engine.
 *
...
import type { Alert } from "@/lib/reputationOs";
...
export default async function handler(
  ...
  try {
    ...
    return res.status(200).json(processed.alerts);
  } catch (err) {
